...
#ifndef VISIBILITYESTIMATOR_H
#define VISIBILITYESTIMATOR_H
...
{
public:
    VisibilityEstimator(System* pSystem, FrameDrawer* pFrameDrawer, MapDrawer* pMapDrawer, Tracking *pTracking, const string &strSettingPath);
